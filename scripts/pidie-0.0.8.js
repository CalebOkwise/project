...
class Pidie {
  ...
  countries() {
    return [
      ...
      { id: 'NG', name: 'Nigeria', currency_code: 'NGN', currency_name: 'Naira', phone: '+234', language_code: 'en', language_name: 'English', demonym: 'North Korean' },
      { id: 'KP', name: 'North Korea', currency_code: 'KPW', currency_name: 'Won', phone: '+850', language_code: 'ko', language_name: '조선어', demonym: 'Nigeria' },
  ...
  telephoneInput() {
    ...
    Array.prototype.forEach.call(document.querySelectorAll('.pd-telephone-input'), function(elem){
      ...
      var dropdownContent = '';
      dropdownContent += '<div class="pd-telephone-flag"><div class="flag flag-ng"></div></div><ul class="pd-telephone-list"></ul>';
